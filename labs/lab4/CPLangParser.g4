 ...
 */
expr
    :   name=ID LPAREN (args+=expr (COMMA args+=expr)*)? RPAREN     # call          // done
    |   MINUS e=expr                                                # unaryMinus    // done
    ...
    |   IF cond=expr THEN thenBranch=expr ELSE elseBranch=expr FI   # if            // done
    |   name=ID ASSIGN e=expr                                       # assign        // done
    |   LPAREN e=expr RPAREN                                        # paren         // done
    |   ID                                                          # id            // done
    |   INT                                                         # int           // done
    |   FLOAT                                                       # float         // done
    |   BOOL                                                        # bool          // done
