...
public interface CoolParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code specified_dispatch}
	 * labeled alternative in {@link CoolParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSpecified_dispatch(CoolParser.Specified_dispatchContext ctx);
	/**
	 * Visit a parse tree produced by the {@code unspecified_dispatch}
	 * labeled alternative in {@link CoolParser#expr}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUnspecified_dispatch(CoolParser.Unspecified_dispatchContext ctx);
	/**
